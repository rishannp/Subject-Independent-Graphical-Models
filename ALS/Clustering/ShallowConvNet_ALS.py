...
for test_subject in subject_numbers:
    ...
    # Collect training data from all subjects except the test subject
    ...
    # Load test subject's data (using entire dataset)
    ...
    # Determine input dimensions for ShallowConvNet
    ...
    # Clear TensorFlow session and garbage collect to free memory before next iteration
    tf.keras.backend.clear_session()
    gc.collect()

# Save results (optional)
np.save(pjoin(os.getcwd(), 'ShallowConvNet_LOSO_results.npy'), results)
