...
SESSION_NAME="train_min2net"
SCRIPT_NAME="/home/uceerjp/StiegerModel/MIN2NET/MIN2Net.py"  # <-- Absolute full path
LOG_FILE="/home/uceerjp/StiegerModel/MIN2NET/MIN2Net_train_output.log"  # <-- Full path too
RETRY_INTERVAL=60
PYTHON_EXEC="python"

# (Optional) Pick a GPU interactively
...
if tmux has-session -t "$SESSION_NAME" 2>/dev/null; then
  ...
  echo "[INFO] You can attach to it manually:"
