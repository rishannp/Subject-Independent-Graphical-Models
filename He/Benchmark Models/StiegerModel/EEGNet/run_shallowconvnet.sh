...
# Setup
SESSION_NAME="train_shallowconvnet"
SCRIPT_NAME="/home/uceerjp/StiegerModel/EEGNet/ShallowConvNet.py"  # <-- updated script
LOG_FILE="ShallowConvNet_train_output.log"
RETRY_INTERVAL=60
PYTHON_EXEC="python"
